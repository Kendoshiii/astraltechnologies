...
public class VersionChecker {
    ...
    public static boolean isUpdate(String update, String currentVersion) {
    ...
    public static void checkForUpdate(String url, String modid, String currentVersion, EntityPlayer player) {
        if (!ConfigValues.UPDATE_CHECKER_MODS.containsKey(modid) || !ConfigValues.UPDATE_CHECKER_MODS.get(modid))
            return;
        String version = "";
        String name = "";
        ...
        try {
            ...
            Reference.logger.info("Error reading update url: " + url);
            Reference.logger.catching(e);
            return;
        }
        if (updateRequired) {
